...
type AuditSinkSpec struct {
	...
	// if undefined it will default to a level 'none' policy
	// +optional
...
type Policy struct {
	...
	// if not provided this will default to a level 'none'
	// +optional
	Level *Level `json:"level" protobuf:"bytes,1,opt,name=level"`

	// OmitStages is a list of stages for which no events are created.
	// +optional
	OmitStages []Stage `json:"omitStages" protobuf:"bytes,2,opt,name=omitStages"`
}
