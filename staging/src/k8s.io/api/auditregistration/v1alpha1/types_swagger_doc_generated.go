...
var map_Policy = map[string]string{
	...
	"stages": "Stages is a list of stages for which events are created. Must be non-empty if level != none",
...
var map_PolicyRule = map[string]string{
	...
	"className": "ClassName of the AuditClass object. This rule matches requests that are classified with this AuditClass",
	"level":     "The Level that all requests are recorded at. available options: None, Metadata, Request, RequestResponse required",
