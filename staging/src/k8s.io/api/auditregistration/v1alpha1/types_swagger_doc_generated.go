...
var map_AuditSinkSpec = map[string]string{
	...
	"policy":  "Policy defines the policy for selecting which events should be sent to this audit sink if undefined it will default to a level 'none' policy",
...
var map_Policy = map[string]string{
	...
	"level":      "The Level that all requests are recorded at. if not provided this will default to a level 'none'",
	"omitStages": "OmitStages is a list of stages for which no events are created.",
}
