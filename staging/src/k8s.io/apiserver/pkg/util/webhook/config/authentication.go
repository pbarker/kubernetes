...
// DefaultDynamicResolveWrapper is a default wrapper for the dynamic resolver
var DefaultDynamicResolveWrapper = func(AuthenticationInfoResolver) AuthenticationInfoResolver {
	return NewDynamicAuthenticationInfoResolver()
}
...
// ClientConfigFor provides the config for the given server
...
// ClientConfigForService provides the config for the given internal service
...
type dynamicAuthenticationInfoResolver struct{}

// NewDynamicAuthenticationInfoResolver provides a dynamicAuthenticationInfoResolver
func NewDynamicAuthenticationInfoResolver() AuthenticationInfoResolver {
	return &dynamicAuthenticationInfoResolver{}
}

func (c *dynamicAuthenticationInfoResolver) ClientConfigFor(server string) (*rest.Config, error) {
	return c.clientConfig(server)
}

func (c *dynamicAuthenticationInfoResolver) ClientConfigForService(serviceName, serviceNamespace string) (*rest.Config, error) {
	return c.clientConfig(serviceName + "." + serviceNamespace + ".svc")
}

func (c *dynamicAuthenticationInfoResolver) clientConfig(target string) (*rest.Config, error) {
