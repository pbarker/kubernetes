...
import (
	...
	webhookconf "k8s.io/apiserver/pkg/util/webhook/config"
	...
	"k8s.io/kubernetes/staging/src/k8s.io/apiserver/pkg/features"
)
...
func (o *AuditOptions) ApplyTo(
	c *server.Config,
	authInfoResolver webhookconf.AuthenticationInfoResolverWrapper,
...
func (o *AuditDynamicOptions) applyTo(
	...
	b, err := plugindynamic.NewBackend(dc)
	if err != nil {
