...
func TestValidatePolicy(t *testing.T) {
	...
	successCases = append(successCases, auditregistration.Policy{ // Policy with omitStages and level
		...
		ClassRules: []auditregistration.ClassRule{
			{
				Name:  "sample",
				Level: auditregistration.LevelRequest,
				Stages: []auditregistration.Stage{
	...
	errorCases = append(errorCases, auditregistration.Policy{ // ClassRule with bad stage
		ClassRules: []auditregistration.ClassRule{
			{
				Name: "test",
				Stages: []auditregistration.Stage{
	...
	errorCases = append(errorCases, auditregistration.Policy{ // ClassRule name blank
		ClassRules: []auditregistration.ClassRule{
			{
				Stages: []auditregistration.Stage{
					auditregistration.Stage("Bad"),
...
func TestAuditClass(t *testing.T) {
	validAttrGroups := []auditregistration.AttributeGroup{
		{ // Matching non-humans
	...
	invalidAttrGroups := []auditregistration.AttributeGroup{
	...
	for _, attrGroup := range invalidAttrGroups {
