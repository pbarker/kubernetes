...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebhookBackend) DeepCopyInto(out *WebhookBackend) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebhookBackend.
func (in *WebhookBackend) DeepCopy() *WebhookBackend {
	if in == nil {
		return nil
	}
	out := new(WebhookBackend)
...
func (in *WebhookThrottleConfig) DeepCopyInto(out *WebhookThrottleConfig) {
	*out = *in
	if in.ThrottleQPS != nil {
		in, out := &in.ThrottleQPS, &out.ThrottleQPS
		*out = new(float32)
		**out = **in
	}
	if in.ThrottleBurst != nil {
		in, out := &in.ThrottleBurst, &out.ThrottleBurst
		*out = new(int64)
		**out = **in
	}
	return
